...
const Menu = (): JSX.Element => {
    return (
        <div className="w-full h-[8vh] flex flex-row items-center justify-around text-lg font-bold bg-slate-800/70">
            ...
            <Link href="/translation" className="text-cyan-400 hover:text-cyan-500 active:text-cyan-300">Translation</Link>
            <Link href="/file" className="text-cyan-400 hover:text-cyan-500 active:text-cyan-300">Translate File</Link>
